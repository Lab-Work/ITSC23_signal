    ...
    def observe(self, step_length, distance):
        ...
        for lane in self.lanes:
            ...
            for vehicle in lane_vehicles:
                ...
                vehicle_measures['distance'] = self.sumo.vehicle.getDistance(vehicle)   # how far the vahicle has gone
                ...
                vehicles[vehicle] = {
                    'wait': vehicle_measures['wait'],
                    'distance': vehicle_measures['distance'],
                    'speed': vehicle_measures['speed']
                }
