map_configs = {
    ...
    'ingolstadt7x': {
        ...
        'net': 'environments/ingolstadt7x/ingolstadt7x.sumocfg',
        'route': None,
        'step_length': 10,
        'yellow_length': 5,
        'step_ratio': 1,
    ...
    'ingolstadt7low': {
        ...
        'net': 'environments/ingolstadt7low/ingolstadt7low.sumocfg',
        'route': None,
        'step_length': 10,
        'yellow_length': 5,
        'step_ratio': 1,
    ...
    'ingolstadt7mid': {
        ...
        'net': 'environments/ingolstadt7mid/ingolstadt7mid.sumocfg',
        'route': None,
        'step_length': 10,
        'yellow_length': 5,
        'step_ratio': 1,
    ...
    'ingolstadt7hig': {
        ...
        'net': 'environments/ingolstadt7hig/ingolstadt7hig.sumocfg',
        'route': None,
        'step_length': 10,
        'yellow_length': 5,
        'step_ratio': 1,
